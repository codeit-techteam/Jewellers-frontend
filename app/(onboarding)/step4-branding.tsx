...
export default function Step4BrandingScreen() {
  ...
  const [logoUri, setLogoUri] = useState<string | null>(step4?.logoUri ?? null);
  const [tagline, setTagline] = useState(step4?.tagline ?? DEFAULT_TAGLINE);
      ...
      >
        ...
        >
          ...
          <View
            ...
            style={{ borderColor: colors.BORDER, backgroundColor: colors.INFO_BG }}
          >
            <Text style={{ fontSize: body, color: colors.NAVY }}>☰</Text>
            <View
              className="mx-3 h-3 flex-1 rounded"
